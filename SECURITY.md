...
The following versions of `aboutme-nextjs` are currently supported with security updates:
...
- Preferred: Open a private report via GitHub Security Advisories — [Create a private advisory](https://github.com/lbenicio/aboutme-nextjs/security/advisories/new)
